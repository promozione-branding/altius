...
export default function ProductClientCTA() {
        ...
        <div className="w-full text-center text-white">
          ...
          >
            <span className="heading-line block">
             Light Up Your Space with the Right Solution
            </span>
          ...
          >
            Looking for reliable LED lighting solutions for your home, office or project? Explore our lighting range or connect with our team for expert guidance and the right solution for your requirements.
          </p>
