            ...
            <div className="lg:pb-1">
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-[10px] font-semibold uppercase tracking-[0.12em] text-gray-900 md:text-base">
                    Elstrong
                  </p>

                  <p className="mt-1 text-[9px] text-gray-500 md:text-sm">
                    Altius Lighting
                  </p>
